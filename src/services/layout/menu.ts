...
function translateMenuData(menu: MenuModel[]) {
 ...
 */
export function newModule(pid: number, name: string, url: string, icon: string, remarks: string, ismenu: number) {
 ...
 * @param {number} ismenu 1-模块 2-接口
 */
export function updateModule(id: number, name: string, url: string, icon: string, remarks: string, ismenu: number) {
